...
class FavoriteViewModel: ViewModel() {
    ...
    val favoriteList = MutableLiveData(mutableListOf<FavoriteVO>())   //  pickItem이 여러개 들어간 즐겨찾기 목록(데이터 전부 포함)
    ...
    // 프로그램의 운동을 즐겨 찾기 추가
    var selectedFavorite = FavoriteVO(mutableListOf(),0,"","","", "", "",  mutableListOf())
