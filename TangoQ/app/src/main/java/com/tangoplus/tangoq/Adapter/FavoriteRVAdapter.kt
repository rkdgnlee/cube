...
class FavoriteRVAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is fvViewHolder) {
            ...
            holder.tvPickName.text = currentItem.name
            holder.tvFvCount.text = currentItem.count
            holder.tvFvTime.text = currentItem.time
            holder.tvFvRegDate.text = currentItem.regDate
            holder.vFvTab.setOnClickListener {
                listener.onFavoriteClick(currentItem.name.toString())
            }
