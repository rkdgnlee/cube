...
class ExerciseJointTypeRVAdapter(var category: Array<String>, private val onCategoryClickListener: OnCategoryClickListener) : RecyclerView.Adapter<ExerciseJointTypeRVAdapter.MyViewHolder>()  {
